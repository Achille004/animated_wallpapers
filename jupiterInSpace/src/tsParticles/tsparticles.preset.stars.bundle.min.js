/*! For license information please see tsparticles.preset.stars.bundle.min.js.LICENSE.txt */ ! function (t, e) {
    ...
    class r {
        constructor(t, e, i) {
            if (this._updateFromAngle = (t, e) => {
                ...
                if (void 0 === t || void 0 === e) throw new Error(`${a} Vector3d not initialized correctly`);
        ...
        add(t) {
            return r.create(this.x + t.x, this.y + t.y, this.z + t.z)
        }
        addTo(t) {
        ...
        div(t) {
            return r.create(this.x / t, this.y / t, this.z / t)
        }
        divTo(t) {
        ...
        rotate(t) {
            return r.create(this.x * Math.cos(t) - this.y * Math.sin(t), this.x * Math.sin(t) + this.y * Math.cos(t), 0)
        }
        setTo(t) {
            this.x = t.x, this.y = t.y;
            const e = t;
    ...
    function _(t) {
        return {
            x: t.position?.x ?? l() * t.size.width,
            y: t.position?.y ?? l() * t.size.height
        }
    }
    ...
    function M(t) {
        if (!z() && "undefined" != typeof matchMedia) return matchMedia(t)
    }
    ...
    function k(t, e, i = !0) {
        return t[void 0 !== e && i ? e % t.length : function (t) {
            return Math.floor(l() * t.length)
        }(t)]
    }
    ...
    function S(t, ...e) {
        for (const i of e) {
            ...
            !e || !U(t) && t && Array.isArray(t) ? e || !U(t) && t && !Array.isArray(t) || (t = {}) : t = [];
            for (const e in i) {
                if ("__proto__" === e) continue;
                const s = i[e],
                    o = t;
                o[e] = U(s) && Array.isArray(s) ? s.map((t => S(o[e], t))) : S(o[e], s)
            }
        }
        return t
    }
        ...
        if (s.enable) {
            switch (o.decay = 1 - p(s.decay), s.mode) {
                ...
                case "decrease":
                    ...
                    break;
                case "random":
                    o.status = l() >= .5 ? "increasing" : "decreasing"
            }
            const t = "auto" === s.mode;
            switch (s.startValue) {
                case "min":
                ...
                case "max":
                    ...
                    break;
                default:
                    o.value = u(o), t && (o.status = l() >= .5 ? "increasing" : "decreasing")
            }
        }
    ...
    function q(t, e, i = !0) {
        ...
        if (F(s.value)) return G(s.value, e, i);
        if (V(s.value)) return q({
            value: k(s.value, e, i)
        });
        for (const [, t] of W) {
    ...
    function G(t, e, i = !0) {
        ...
        if (F(s.value)) return s.value === B ? Z() : function (t) {
            return $(t)
        }(s.value);
        if (V(s.value)) return G({
            value: k(s.value, e, i)
        });
        for (const [, t] of W) {
    ...
    function j(t) {
        ...
        const a = (t, e, i) => (i < 0 && (i += 1), i > 1 && (i -= 1), 6 * i < 1 ? t + 6 * (e - t) * i : 2 * i < 1 ? e : 3 * i < 2 ? t + (e - t) * (2 / 3 - i) * 6 : t),
            r = n < .5 ? n * (1 + o) : n + o - n * o,
            c = 2 * n - r,
            h = Math.min(255, 255 * a(c, r, s + 1 / 3)),
            l = Math.min(255, 255 * a(c, r, s)),
    ...
    function Z(t) {
        const e = t ?? 0;
        return {
            b: Math.floor(u(m(e, 256))),
            g: Math.floor(u(m(e, 256))),
            r: Math.floor(u(m(e, 256)))
        }
    }
    ...
    function K(t, e, i) {
        t.enable = e.enable, t.enable ? (t.velocity = p(e.speed) / 100 * i, t.decay = 1 - p(e.decay), t.status = "increasing", t.loops = 0, t.maxLoops = p(e.count), t.time = 0, t.delayTime = 1e3 * p(e.delay), e.sync || (t.velocity *= l(), t.value *= l()), t.initialValue = t.value) : t.velocity = 0
    }
    ...
    class it {
        constructor(t) {
            this.container = t, this._applyPostDrawUpdaters = t => {
                ...
                for (const s of this._colorPlugins)
                    if (!e && s.particleFillColor && (e = X(s.particleFillColor(t))), !i && s.particleStrokeColor && (i = X(s.particleStrokeColor(t))), e && i) break;
                return [e, i]
            }, this._initCover = () => {
                ...
                if (e) {
                    ...
                    this._coverColorStyle = N(i, i.a)
                }
            }, this._initStyle = () => {
                const t = this.element,
                    e = this.container.actualOptions;
                if (t) {
                    this._fullScreen ? (this._originalStyle = S({}, t.style), this._setFullScreenStyle()) : this._resetOriginalStyle();
        ...
        clear() {
            const t = this.container.actualOptions,
                e = t.particles.move.trail,
                i = this._trailFill;
            t.backgroundMask.enable ? this.paint() : e.enable && e.length > 0 && i ? i.color ? this._paintBase(N(i.color, i.opacity)) : i.image && this._paintImage(i.image, i.opacity) : t.clear && this.draw((t => {
                tt(t, this.size)
            }))
        }
        destroy() {
        ...
        drawParticle(t, e) {
            ...
            n || (n = s), a || (a = o), (n || a) && this.draw((s => {
                ...
                f.stroke = a ? Q(a, u) : f.fill, this._applyPreDrawUpdaters(s, t, i, d, f, p),
                    function (t) {
                        const {
                            container: e,
                            context: i,
                            ...
                            shadow: l,
                            transform: d
                        } = t, u = s.getPosition(), p = s.rotation + (s.pathRotation ? s.velocity.angle : 0), f = Math.sin(p), v = Math.cos(p), m = {
                            a: v * (d.a ?? 1),
                            b: f * (d.b ?? 1),
                            c: -f * (d.c ?? 1),
                            d: v * (d.d ?? 1)
                        };
                        i.setTransform(m.a, m.b, m.c, m.d, u.x, u.y), a && (i.globalCompositeOperation = r);
                        const y = s.shadowColor;
                        l.enable && y && (i.shadowBlur = l.blur, i.shadowColor = N(y), i.shadowOffsetX = l.offset.x, i.shadowOffsetY = l.offset.y), n.fill && (i.fillStyle = n.fill);
                        ...
                        i.beginPath(),
                            ...
                            }(_), s.shapeClose && i.closePath(), g > 0 && i.stroke(), s.shapeFill && i.fill(),
                            function (t) {
                                const {
                                    container: e,
                                    context: i,
                            ...
                            }(_), i.globalCompositeOperation = "source-over", i.setTransform(1, 0, 0, 1, 0, 0)
                    }({
                        container: o,
                        context: s,
                        particle: t,
        ...
        drawParticlePlugin(t, e, i) {
            this.draw((s => function (t, e, i, s) {
                e.drawParticle && e.drawParticle(t, i, s)
            }(s, t, e, i)))
        }
        drawPlugin(t, e) {
            this.draw((i => function (t, e, i) {
                e.draw && e.draw(t, i)
            }(i, t, e)))
        }
        async init() {
            this._safeMutationObserver((t => t.disconnect())), this._mutationObserver = function (t) {
                if (!z() && "undefined" != typeof MutationObserver) return new MutationObserver(t)
            }((t => {
        ...
        initBackground() {
            ...
            if (i) {
                if (t.color) {
                    const e = q(t.color);
                    i.backgroundColor = e ? N(e, t.opacity) : ""
        ...
        paint() {
            const t = this.container.actualOptions;
            this.draw((e => {
                t.backgroundMask.enable && t.backgroundMask.cover ? (tt(e, this.size), this._paintBase(this._coverColorStyle)) : this._paintBase()
            }))
        }
        resize() {
        ...
        stop() {
            this._safeMutationObserver((t => t.disconnect())), this._mutationObserver = void 0, this.draw((t => tt(t, this.size)))
        }
        async windowResize() {
    ...
    function st(t, e, i, s, o) {
        if (s) {
            let s = {
                passive: !0
            };
            E(o) ? s.capture = o : void 0 !== o && (s = o), t.addEventListener(e, i, s)
        } else {
            const s = o;
        ...
        constructor(t) {
            this.container = t, this._doMouseTouchClick = t => {
                ...
                if (this._canPush) {
                    ...
                    T(i.interactivity.events.onClick.mode, (t => this.container.handleClickMode(t)))
                }
                ...
                const i = this._handlers,
                    s = this.container,
                    a = s.actualOptions,
                    r = s.interactivity.element;
                if (!r) return;
                const c = r,
                    h = s.canvas.element;
                h && (h.style.pointerEvents = c === h ? "initial" : "none"), (a.interactivity.events.onHover.enable || a.interactivity.events.onClick.enable) && (st(r, o, i.mouseMove, e), st(r, "touchstart", i.touchStart, e), st(r, "touchmove", i.touchMove, e), a.interactivity.events.onClick.enable ? (st(r, n, i.touchEndClick, e), st(r, "pointerup", i.mouseUp, e), st(r, "pointerdown", i.mouseDown, e)) : st(r, n, i.touchEnd, e), st(r, t, i.mouseLeave, e), st(r, "touchcancel", i.touchCancel, e))
                ...
                const e = this._handlers,
                    ...
                    n = i.canvas.element;
                let a = s;
                "window" === o ? (i.interactivity.element = window, a = "pointerout") : i.interactivity.element = "parent" === o && n ? n.parentElement ?? n.parentNode : n, this._manageMediaMatch(t), this._manageResize(t), this._manageInteractivityListeners(a, t), document && st(document, "visibilitychange", e.visibilityChange, t, !1)
            }, this._manageMediaMatch = t => {
                const e = this._handlers,
                    i = M("(prefers-color-scheme: dark)");
                i && (void 0 === i.addEventListener ? void 0 !== i.addListener && (t ? i.addListener(e.oldThemeChange) : i.removeListener(e.oldThemeChange)) : st(i, "change", e.themeChange, t))
            }, this._manageResize = t => {
                const e = this._handlers,
                    i = this.container;
                if (!i.actualOptions.interactivity.events.resize) return;
                if ("undefined" == typeof ResizeObserver) return void st(window, "resize", e.resize, t);
                ...
                if (!t) return;
                const e = t.mouse;
                delete e.position, delete e.clickPosition, delete e.downPosition, t.status = s, e.inside = !1, e.clicking = !1
                ...
                if (s.mouse.inside = !0, t.type.startsWith("pointer")) {
                    ...
                    if (s.element === window) {
                        ...
                        if (t && i && n) {
                            ...
                            a = {
                                x: e.offsetX + 2 * s.left - (o.left + r.left),
                                y: e.offsetY + 2 * s.top - (o.top + r.top)
                            }
                        } else a = {
                ...
                const r = e.retina.pixelRatio;
                a && (a.x *= r, a.y *= r), s.mouse.position = a, s.status = o
            }, this._touchEnd = t => {
                const e = t,
    ...
    class nt {
        ...
        static create(t, e) {
            const i = new nt;
            return i.load(t), void 0 !== e && (F(e) || V(e) ? i.load({
                value: e
            }) : i.load(e)), i
        }
        load(t) {
    ...
    class at {
        ...
        load(t) {
            t && (void 0 !== t.color && (this.color = nt.create(this.color, t.color)), void 0 !== t.image && (this.image = t.image), void 0 !== t.position && (this.position = t.position), void 0 !== t.repeat && (this.repeat = t.repeat), void 0 !== t.size && (this.size = t.size), void 0 !== t.opacity && (this.opacity = t.opacity))
        }
    }
    class rt {
        constructor() {
            this.color = new nt, this.color.value = "#fff", this.opacity = 1
        }
        load(t) {
            t && (void 0 !== t.color && (this.color = nt.create(this.color, t.color)), void 0 !== t.opacity && (this.opacity = t.opacity))
        }
    }
    class ct {
        constructor() {
    ...
    class pt {
        constructor() {
            this.enable = !1, this.mode = [], this.parallax = new ut
        }
        load(t) {
    ...
    class vt {
        constructor() {
            this.onClick = new lt, this.onDiv = new dt, this.onHover = new pt, this.resize = new ft
        }
        load(t) {
            if (!t) return;
            this.onClick.load(t.onClick);
            const e = t.onDiv;
            void 0 !== e && (this.onDiv = T(e, (t => {
                const e = new dt;
                return e.load(t), e
    ...
    class yt {
        constructor(t, e) {
            this.detectsOn = "window", this.events = new vt, this.modes = new mt(t, e)
        }
        load(t) {
            if (!t) return;
            const e = t.detectsOn;
    ...
    class gt {
        load(t) {
            ...
            }), t.options && (this.options = S({}, t.options)))
        }
    }
    class _t {
        constructor() {
        ...
        load(t) {
            t && (void 0 !== t.maxWidth && (this.maxWidth = t.maxWidth), void 0 !== t.mode && ("screen" === t.mode ? this.mode = "screen" : this.mode = "canvas"), void 0 !== t.options && (this.options = S({}, t.options)))
        }
    }
    class wt {
        constructor() {
    ...
    class bt {
        ...
        load(t) {
            t && (void 0 !== t.name && (this.name = t.name), this.default.load(t.default), void 0 !== t.options && (this.options = S({}, t.options)))
        }
    }
    class xt {
        constructor() {
        ...
        load(t) {
            t && (void 0 !== t.count && (this.count = m(t.count)), void 0 !== t.enable && (this.enable = t.enable), void 0 !== t.speed && (this.speed = m(t.speed)), void 0 !== t.decay && (this.decay = m(t.decay)), void 0 !== t.delay && (this.delay = m(t.delay)), void 0 !== t.sync && (this.sync = t.sync))
        }
    }
    class zt extends xt {
        constructor() {
    ...
    class Mt extends xt {
        ...
        load(t) {
            super.load(t), t && void 0 !== t.offset && (this.offset = m(t.offset))
        }
    }
    class Pt {
        constructor() {
            this.h = new Mt, this.s = new Mt, this.l = new Mt
        }
        load(t) {
    ...
    class St {
        ...
        load(t) {
            t && void 0 !== t.value && (this.value = m(t.value))
        }
    }
    class Tt extends St {
        constructor() {
    ...
    class It {
        constructor() {
            this.horizontal = new Rt, this.vertical = new Rt
        }
        load(t) {
    ...
    class Lt {
        constructor() {
            this.absorb = new Ot, this.bounce = new It, this.enable = !1, this.maxSpeed = 50, this.mode = "bounce", this.overlap = new Ct
        }
        load(t) {
            t && (this.absorb.load(t.absorb), this.bounce.load(t.bounce), void 0 !== t.enable && (this.enable = t.enable), void 0 !== t.maxSpeed && (this.maxSpeed = m(t.maxSpeed)), void 0 !== t.mode && (this.mode = t.mode), this.overlap.load(t.overlap))
        }
    }
    class Et {
        constructor() {
        ...
        load(t) {
            ...
            if (void 0 !== e)
                for (const t in e) {
                    const i = e[t];
                    i && (this.options[t] = S(this.options[t] ?? {}, i))
                }
    ...
    class At {
        ...
        load(t) {
            if (t && (void 0 !== t.distance && (this.distance = m(t.distance)), void 0 !== t.enable && (this.enable = t.enable), t.rotate)) {
                const e = t.rotate.x;
    ...
    class Bt {
        constructor() {
            this.clamp = !0, this.delay = new St, this.enable = !1, this.options = {}
        }
        load(t) {
            t && (void 0 !== t.clamp && (this.clamp = t.clamp), this.delay.load(t.delay), void 0 !== t.enable && (this.enable = t.enable), this.generator = t.generator, t.options && (this.options = S(this.options, t.options)))
        }
    }
    class Wt {
        load(t) {
            t && (void 0 !== t.color && (this.color = nt.create(this.color, t.color)), void 0 !== t.image && (this.image = t.image))
        }
    }
    class Ht {
        constructor() {
            this.enable = !1, this.length = 10, this.fill = new Wt
        }
        load(t) {
    ...
    class qt {
        ...
        load(t) {
            t && (void 0 !== t.acceleration && (this.acceleration = m(t.acceleration)), void 0 !== t.enable && (this.enable = t.enable), t.position && (this.position = S({}, t.position)))
        }
    }
    class Gt {
        constructor() {
            this.angle = new Ft, this.attract = new At, this.center = new Ut, this.decay = 0, this.distance = {}, this.direction = "none", this.drift = 0, this.enable = !1, this.gravity = new Vt, this.path = new Bt, this.outModes = new $t, this.random = !1, this.size = !1, this.speed = 2, this.spin = new qt, this.straight = !1, this.trail = new Ht, this.vibrate = !1, this.warp = !1
        }
        load(t) {
            if (!t) return;
            this.angle.load(A(t.angle) ? {
                value: t.angle
            } : t.angle), this.attract.load(t.attract), this.center.load(t.center), void 0 !== t.decay && (this.decay = m(t.decay)), void 0 !== t.direction && (this.direction = t.direction), void 0 !== t.distance && (this.distance = A(t.distance) ? {
                horizontal: t.distance,
                vertical: t.distance
            } : {
                ...t.distance
            }), void 0 !== t.drift && (this.drift = m(t.drift)), void 0 !== t.enable && (this.enable = t.enable), this.gravity.load(t.gravity);
            const e = t.outModes;
            void 0 !== e && (U(e) ? this.outModes.load(e) : this.outModes.load({
                default: e
            })), this.path.load(t.path), void 0 !== t.random && (this.random = t.random), void 0 !== t.size && (this.size = t.size), void 0 !== t.speed && (this.speed = m(t.speed)), this.spin.load(t.spin), void 0 !== t.straight && (this.straight = t.straight), this.trail.load(t.trail), void 0 !== t.vibrate && (this.vibrate = t.vibrate), void 0 !== t.warp && (this.warp = t.warp)
        }
    }
    class Xt extends zt {
        constructor() {
    ...
    class Yt extends Dt {
        constructor() {
            super(), this.animation = new Xt, this.value = 1
        }
        load(t) {
            if (!t) return;
            super.load(t);
    ...
    class Nt {
        constructor() {
            this.density = new jt, this.limit = new Zt, this.value = 0
        }
        load(t) {
    ...
    class Qt {
        ...
        load(t) {
            t && (void 0 !== t.blur && (this.blur = t.blur), this.color = nt.create(this.color, t.color), void 0 !== t.enable && (this.enable = t.enable), void 0 !== t.offset && (void 0 !== t.offset.x && (this.offset.x = t.offset.x), void 0 !== t.offset.y && (this.offset.y = t.offset.y)))
        }
    }
    class Jt {
        constructor() {
    ...
    class te extends Dt {
        constructor() {
            super(), this.animation = new Kt, this.value = 3
        }
        load(t) {
            if (super.load(t), !t) return;
            const e = t.animation;
    ...
    class ee {
        ...
        load(t) {
            t && (void 0 !== t.color && (this.color = kt.create(this.color, t.color)), void 0 !== t.width && (this.width = m(t.width)), void 0 !== t.opacity && (this.opacity = m(t.opacity)))
        }
    }
    class ie extends St {
        constructor() {
    ...
    class se {
        constructor(t, e) {
            this._engine = t, this._container = e, this.bounce = new It, this.collisions = new Lt, this.color = new kt, this.color.value = "#fff", this.effect = new Et, this.groups = {}, this.move = new Gt, this.number = new Nt, this.opacity = new Yt, this.reduceDuplicates = !1, this.shadow = new Qt, this.shape = new Jt, this.size = new te, this.stroke = new ee, this.zIndex = new ie
        }
        load(t) {
            if (!t) return;
            if (void 0 !== t.groups)
                for (const e of Object.keys(t.groups)) {
                    ...
                    const i = t.groups[e];
                    void 0 !== i && (this.groups[e] = S(this.groups[e] ?? {}, i))
                }
            void 0 !== t.reduceDuplicates && (this.reduceDuplicates = t.reduceDuplicates), this.bounce.load(t.bounce), this.color.load(kt.create(this.color, t.color)), this.effect.load(t.effect), this.move.load(t.move), this.number.load(t.number), this.opacity.load(t.opacity), this.shape.load(t.shape), this.size.load(t.size), this.shadow.load(t.shadow), this.zIndex.load(t.zIndex), this.collisions.load(t.collisions), void 0 !== t.interactivity && (this.interactivity = S({}, t.interactivity));
            const e = t.stroke;
            if (e && (this.stroke = T(e, (t => {
                    const e = new ee;
                    return e.load(t), e
                }))), this._container) {
    ...
    class ae {
        constructor(t, e) {
            ...
            }, this._engine = t, this._container = e, this.autoPlay = !0, this.background = new at, this.backgroundMask = new ct, this.clear = !0, this.defaultThemes = {}, this.delay = 0, this.fullScreen = new ht, this.detectRetina = !0, this.duration = 0, this.fpsLimit = 120, this.interactivity = new yt(t, e), this.manualParticles = [], this.particles = ne(this._engine, this._container), this.pauseOnBlur = !0, this.pauseOnOutsideViewport = !0, this.responsive = [], this.smooth = !1, this.style = {}, this.themes = [], this.zLayers = 100
        }
        load(t) {
            if (!t) return;
            void 0 !== t.preset && T(t.preset, (t => this._importPreset(t))), void 0 !== t.autoPlay && (this.autoPlay = t.autoPlay), void 0 !== t.clear && (this.clear = t.clear), void 0 !== t.name && (this.name = t.name), void 0 !== t.delay && (this.delay = m(t.delay));
            const e = t.detectRetina;
            void 0 !== e && (this.detectRetina = e), void 0 !== t.duration && (this.duration = m(t.duration));
            const i = t.fpsLimit;
            ...
            E(s) ? this.fullScreen.enable = s : this.fullScreen.load(s), this.backgroundMask.load(t.backgroundMask), this.interactivity.load(t.interactivity), t.manualParticles && (this.manualParticles = t.manualParticles.map((t => {
                const e = new gt;
                return e.load(t), e
            }))), this.particles.load(t.particles), this.style = S(this.style, t.style), this._engine.loadOptions(this, t), void 0 !== t.smooth && (this.smooth = t.smooth);
        ...
        setTheme(t) {
            if (t) {
                ...
                const t = M("(prefers-color-scheme: dark)"),
                    e = t && t.matches,
    ...
    function ce(t) {
        if (!P(t.outMode, t.checkModes)) return;
        const e = 2 * t.radius;
    ...
    class he {
        constructor(t, e, i, s, o, n) {
            this.container = i, this._calcPosition = (t, e, i, s = 0) => {
                for (const [, s] of t.plugins) {
                    ...
                    if (t) return r.create(t.x, t.y, i)
                }
                const o = _({
                        size: t.canvas.size,
                        position: e
                    }),
                    n = r.create(o.x, o.y, i),
                    a = this.getRadius(),
                ...
                return h(c.left ?? c.default), h(c.right ?? c.default), l(c.top ?? c.default), l(c.bottom ?? c.default), this._checkOverlap(n, s) ? this._calcPosition(t, void 0, i, s + 1) : n
                ...
                return e.straight || (t.angle += u(m(o.left, o.right))), e.random && "number" == typeof e.speed && (t.length *= l()), t
                ...
                const n = o.retries;
                if (n >= 0 && e > n) throw new Error(`${a} particle is overlapping and can't be placed`);
                ...
                return Math.floor(((this.roll.angle ?? 0) + i) / (Math.PI / e)) % 2 ? this.backColor ? this.backColor : this.roll.alter ? function (t, e, i) {
                    return {
                        h: t.h,
                        s: t.s,
                ...
                this.position = this._calcPosition(e, t, d(i, 0, e.zLayers)), this.initialPosition = this.position.copy();
                const s = e.canvas.size;
                switch (this.moveCenter = {
                    ...L(this.options.move.center, s),
                    radius: this.options.move.center.radius ?? 0,
                    mode: this.options.move.center.mode ?? "percent"
                }, this.direction = function (t, e, i) {
                    if (A(t)) return t * Math.PI / 180;
                    switch (t) {
                        case "top":
                            return .5 * -Math.PI;
                        case "top-right":
        ...
        getFillColor() {
            return this._getRollColor(this.bubble.color ?? J(this.color))
        }
        getMass() {
        ...
        getStrokeColor() {
            return this._getRollColor(this.bubble.color ?? J(this.strokeColor))
        }
        init(t, e, i, s) {
            const o = this.container,
                n = this._engine;
            ...
            const a = o.retina.pixelRatio,
                r = o.actualOptions,
                c = ne(this._engine, o, r.particles),
                h = c.effect.type,
                l = c.shape.type,
                {
                    reduceDuplicates: d
                } = c;
            this.effect = D(h, this.id, d), this.shape = D(l, this.id, d);
            const u = c.effect,
                f = c.shape;
            if (i) {
                if (i.effect && i.effect.type) {
                    const t = D(i.effect.type, this.id, d);
                    t && (this.effect = t, u.load(i.effect))
                }
                if (i.shape && i.shape.type) {
                    const t = D(i.shape.type, this.id, d);
                    t && (this.shape = t, f.load(i.shape))
                }
            }
            ...
            }(this.shape, f, this.id, d), c.load(i);
            const v = this.effectData;
            v && c.load(v.particles);
            const m = this.shapeData;
            m && c.load(m.particles);
            const y = new yt(n, o);
            y.load(o.actualOptions.interactivity), y.load(c.interactivity), this.interactivity = y, this.effectFill = v?.fill ?? c.effect.fill, this.effectClose = v?.close ?? c.effect.close, this.shapeFill = m?.fill ?? c.shape.fill, this.shapeClose = m?.close ?? c.shape.close, this.options = c;
            const g = this.options.move.path;
            this.pathDelay = 1e3 * p(g.delay.value), g.generator && (this.pathGenerator = this._engine.getPathGenerator(g.generator), this.pathGenerator && o.addPath(g.generator, this.pathGenerator) && this.pathGenerator.init(o)), o.retina.initParticle(this), this.size = R(this.options.size, a), this.bubble = {
                inRange: !1
            }, this.slow = {
                inRange: !1,
                factor: 1
            ...
            const _ = o.particles;
            _.setLastZIndex(this.position.z), this.zIndexFactor = this.position.z / o.zLayers, this.sides = 24;
            ...
            x && (this.sides = x(this)), this.spawning = !1, this.shadowColor = q(this.options.shadow.color);
            for (const t of _.updaters) t.init(this);
            for (const t of _.movers) t.init && t.init(this);
    ...
    class ue extends de {
        ...
        intersects(t) {
            t instanceof pe && t.intersects(this);
            const e = this.size.width,
                i = this.size.height,
                s = this.position,
                o = t.position,
                n = t instanceof ue ? t.size : {
                    width: 0,
                    height: 0
                },
                a = n.width,
    ...
    class fe {
        constructor(t, e) {
            this.rectangle = t, this.capacity = e, this._subdivide = () => {
                ...
                for (let n = 0; n < 4; n++) this._subs.push(new fe(new ue(t + .5 * i * (n % 2), e + .5 * s * (Math.round(.5 * n) - n % 2), .5 * i, .5 * s), o));
                this._divided = !0
        ...
        query(t, e, i) {
            ...
            for (const i of this._points) !t.contains(i.position) && g(t.position, i.position) > i.particle.getRadius() && (!e || e(i.particle)) || s.push(i.particle);
            if (this._divided)
                for (const i of this._subs) i.query(t, e, s);
            return s
        }
        queryCircle(t, e, i) {
            return this.query(new pe(t.x, t.y, e), i)
        }
        queryRectangle(t, e, i) {
            return this.query(new ue(t.x, t.y, e.width, e.height), i)
        }
    }
    const ve = t => {
        const {
        ...
        return new ue(-.25 * i, -.25 * e, 1.5 * i, 1.5 * e)
    };
    class me {
        constructor(t, e) {
            this._addToPool = (...t) => {
                ...
                try {
                    ...
                    o ? o.init(this._nextId, t, e, i) : o = new he(this._engine, this._nextId, this._container, t, e, i);
                    let n = !0;
                    if (s && (n = s(o)), !n) return;
                    ...
                    return void x().warning(`${a} adding particle: ${t}`)
                }
            ...
            }, this._engine = t, this._container = e, this._nextId = 0, this._array = [], this._zArray = [], this._pool = [], this._limit = 0, this._groupLimits = new Map, this._needsSort = !1, this._lastZIndex = 0, this._interactionManager = new re(t, e);
            const i = e.canvas.size;
            this.quadTree = new fe(ve(i), 4), this.movers = this._engine.getMovers(e, !0), this.updaters = this._engine.getUpdaters(e, !0)
        }
        get count() {
        ...
        addManualParticles() {
            const t = this._container,
                e = t.actualOptions;
            for (const i of e.manualParticles) this.addParticle(i.position ? L(i.position, t.canvas.size) : void 0, i.options)
        }
        addParticle(t, e, i, s) {
        ...
        async update(t) {
            const e = this._container,
                i = new Set;
            this.quadTree = new fe(ve(e.canvas.size), 4);
            ...
            for (const e of this._array) {
                ...
                e.destroyed ? i.add(e) : this.quadTree.insert(new le(e.getPosition(), e))
            }
            if (i.size) {
                const t = t => !i.has(t);
    ...
    class ye {
        ...
        init() {
            const t = this.container,
                e = t.actualOptions;
            this.pixelRatio = !e.detectRetina || z() ? 1 : window.devicePixelRatio, this.reduceFactor = 1;
    ...
    class we {
        constructor(t, e, i) {
            this._intersectionManager = t => {
                if (ge(this) && this.actualOptions.pauseOnOutsideViewport)
                ...
                try {
                    ...
                    x().error(`${a} in animation loop`, t)
                }
            }, this._engine = t, this.id = Symbol(e), this.fpsLimit = 120, this._smooth = !1, this._delay = 0, this._duration = 0, this._lifeTime = 0, this._firstStart = !0, this.started = !1, this.destroyed = !1, this._paused = !0, this._lastFrameTime = 0, this.zLayers = 100, this.pageHidden = !1, this._sourceOptions = i, this._initialSourceOptions = i, this.retina = new ye(this), this.canvas = new it(this), this.particles = new me(this._engine, this), this.pathGenerators = new Map, this.interactivity = {
                mouse: {
                    clicking: !1,
                    inside: !1
                }
            }, this.plugins = new Map, this.effectDrawers = new Map, this.shapeDrawers = new Map, this._options = _e(this._engine, this), this.actualOptions = _e(this._engine, this), this._eventListeners = new ot(this), this._intersectionObserver = function (t) {
                if (!z() && "undefined" != typeof IntersectionObserver) return new IntersectionObserver(t)
            }((t => this._intersectionManager(t))), this._engine.dispatchEvent("containerBuilt", {
                container: this
            })
        }
        get options() {
        ...
        addPath(t, e, i = !1) {
            return !(!ge(this) || !i && this.pathGenerators.has(t)) && (this.pathGenerators.set(t, e), !0)
        }
        alive() {
        ...
        async export (t, e = {}) {
            ...
            x().error(`${a} - Export plugin with type ${t} not found`)
        }
        getAnimationStatus() {
            return !this._paused && !this.pageHidden && ge(this)
        }
        handleClickMode(t) {
            if (ge(this)) {
        ...
        async init() {
            ...
            this._options = _e(this._engine, this, this._initialSourceOptions, this.sourceOptions), this.actualOptions = _e(this._engine, this, this._options);
        ...
        async loadTheme(t) {
            ge(this) && (this._currentTheme = t, await this.refresh())
        }
        pause() {
            if (ge(this) && (void 0 !== this._drawAnimationFrame && (cancelAnimationFrame(this._drawAnimationFrame), delete this._drawAnimationFrame), !this._paused)) {
        ...
        async refresh() {
            if (ge(this)) return this.stop(), this.start()
        }
        async reset() {
            if (ge(this)) return this._initialSourceOptions = void 0, this._options = _e(this._engine, this), this.actualOptions = _e(this._engine, this, this._options), this.refresh()
        }
        async start() {
            ge(this) && !this.started && (await this.init(), this.started = !0, await new Promise((t => {
    ...
    function xe(t, e, i, s = !1) {
        let o = e.get(t);
        return o && !s || (o = [...i.values()].map((e => e(t))), e.set(t, o)), o
    }
    class ze {
        constructor() {
            this._configs = new Map, this._domArray = [], this._eventDispatcher = new be, this._initialized = !1, this.plugins = [], this._initializers = {
                interactors: new Map,
                movers: new Map,
                updaters: new Map
        ...
        getInteractors(t, e = !1) {
            return xe(t, this.interactors, this._initializers.interactors, e)
        }
        getMovers(t, e = !1) {
            return xe(t, this.movers, this._initializers.movers, e)
        }
        getPathGenerator(t) {
        ...
        getUpdaters(t, e = !1) {
            return xe(t, this.updaters, this._initializers.updaters, e)
        }
        init() {
            this._initialized || (this._initialized = !0)
        }
        async load(t) {
            const e = t.id ?? t.element?.id ?? `tsparticles${Math.floor(1e4*l())}`,
                {
                    index: s,
                    url: o
                } = t,
                n = o ? await async function (t) {
                    const e = D(t.url, t.index);
                    if (!e) return t.fallback;
                    const i = await fetch(e);
                    return i.ok ? i.json() : (x().error(`${a} ${i.status} while retrieving config file`), t.fallback)
                }({
                    fallback: t.options,
                    url: o,
                    index: s
                }): t.options;
            let r = t.element ?? document.getElementById(e);
            r || (r = document.createElement("div"), r.id = e, document.body.append(r));
            const c = D(n, s),
                h = this.dom(),
                d = h.findIndex((t => t.id.description === e));
            if (d >= 0) {
                const t = this.domItem(d);
                t && !t.destroyed && (t.destroy(), h.splice(d, 1))
            }
            let u;
            if ("canvas" === r.tagName.toLowerCase()) u = r, u.dataset[i] = "false";
            else {
                const t = r.getElementsByTagName("canvas");
                t.length ? (u = t[0], u.dataset[i] = "false") : (u = document.createElement("canvas"), u.dataset[i] = "true", r.appendChild(u))
            }
            u.style.width || (u.style.width = "100%"), u.style.height || (u.style.height = "100%");
            const p = new we(this, e, c);
            return d >= 0 ? h.splice(d, 0, p) : h.push(p), p.canvas.loadCanvas(u), await p.start(), p
        }
        loadOptions(t, e) {
        ...
        setOnClickHandler(t) {
            const e = this.dom();
            if (!e.length) throw new Error(`${a} can only set click handlers after calling tsParticles.load()`);
    ...
    class Me {
        ...
        handleColor(t) {
            ...
            if (void 0 !== e.h && void 0 !== e.s && void 0 !== e.l) return j(e)
        }
        handleRangeColor(t) {
            const e = t.value.hsl ?? t.value;
            if (void 0 !== e.h && void 0 !== e.l) return j({
                h: p(e.h),
                l: p(e.l),
                s: p(e.s)
            })
    ...
    function Oe(t, e, i, s, o, n) {
        ! function (t, e) {
            ...
            s.clamp && (t.velocity.x = d(t.velocity.x, -1, 1), t.velocity.y = d(t.velocity.y, -1, 1));
        ...
        a?.enable && s > 0 && (!a.inverse && h.y >= 0 && h.y >= s || a.inverse && h.y <= 0 && h.y <= -s) && (h.y = r * s, i && (t.velocity.y = h.y / i));
        const l = t.options.zIndex,
            u = (1 - t.zIndexFactor) ** l.velocityRate;
        h.multTo(u);
        const {
            position: p
        } = t;
    ...
    class Ce {
        ...
        move(t, e) {
            ...
            const o = t.container,
                ...
                h = v(i.size.value) * n,
                d = r * (s.size ? t.getRadius() / h : 1) * a * (e.factor || 1) / 2,
                u = t.retina.maxSpeed ?? o.retina.maxSpeed;
            s.spin.enable ? function (t, e) {
                ...
                function (t) {
                    ...
                    if (r || c)
                        ...
                        const i = t.position,
                            s = t.velocity;
                        r && (i.x < e.x && s.x < 0 || i.x > e.x && s.x > 0) && (s.x *= -l()), c && (i.y < e.y && s.y < 0 || i.y > e.y && s.y > 0) && (s.y *= -l())
                    }
                }(t)
        }
    }
    ...
    class De {
        ...
        init(t) {
            const e = X(t.options.color, t.id, t.options.reduceDuplicates);
            e && (t.color = function (t, e, i) {
                const s = {
                    h: {
                        enable: !1,
                        value: t.h
                ...
                return e && (K(s.h, e.h, i), K(s.s, e.s, i), K(s.l, e.l, i)), s
            }(e, t.options.color.animation, this.container.retina.reduceFactor))
        }
        isEnabled(t) {
            const {
                h: e,
        ...
        update(t, e) {
            ! function (t, e) {
                ...
                a && Te(e, a, i, 360, !1), r && Te(e, r, s, 100, !0), c && Te(e, c, o, 100, !0)
            }(t, e)
        }
    }
    class Re {
        ...
        init(t) {
            ...
            t.opacity = R(e, 1);
            const i = e.animation;
            i.enable && (t.opacity.velocity = p(i.speed) / 100 * this.container.retina.reduceFactor, i.sync || (t.opacity.velocity *= l()))
        }
        isEnabled(t) {
            ...
            this.isEnabled(t) && function (t, e) {
                ...
                if (i.time || (i.time = 0), (i.delayTime ?? 0) > 0 && i.time < (i.delayTime ?? 0) && (i.time += e.value), !((i.delayTime ?? 0) > 0 && i.time < (i.delayTime ?? 0))) {
                    ...
                    i.velocity && 1 !== i.decay && (i.velocity *= n),
                        ...
                        }(t, i.value, s, o), t.destroyed || (i.value = d(i.value, s, o))
                }
            }(t, e)
        }
    }
    ...
    class Le {
        ...
        update(t, e, i, s) {
            ...
            switch (t.outType) {
                case "normal":
                case "outside":
                    if (O(t.position, o.canvas.size, c.origin, t.getRadius(), e)) return;
                    break;
                case "inside": {
                    const {
                        dx: e,
                        dy: i
                    } = y(t.position, t.moveCenter), {
                        x: s,
                        y: o
                    } = t.velocity;
    ...
    class Ee {
        ...
        update(t, e, i, s) {
            ...
            if (o.enable) {
                ...
                O(t.position, n.canvas.size, c.origin, r, e) || n.particles.remove(t)
            }
        }
    }
    class Fe {
            ...
            switch (t.outType) {
                case "inside": {
                    const {
                        x: e,
                        y: i
                    } = t.velocity, s = c.origin;
                    s.length = t.moveCenter.radius, s.angle = t.velocity.angle + Math.PI, s.addTo(c.create(t.moveCenter));
                    const {
                        dx: n,
                        dy: a
                    } = y(t.position, s);
                    if (e <= 0 && n >= 0 || i <= 0 && a >= 0 || e >= 0 && n <= 0 || i >= 0 && a <= 0) return;
                    t.position.x = Math.floor(u({
                        min: 0,
                        max: o.canvas.size.width
                    })), t.position.y = Math.floor(u({
                        min: 0,
                    ...
                    t.direction = Math.atan2(-h, -r), t.velocity.angle = t.direction;
                    break
                }
                default:
                    if (O(t.position, o.canvas.size, c.origin, t.getRadius(), e)) return;
                    switch (t.outType) {
                        case "outside": {
                            ...
                            })) + t.moveCenter.x, t.position.y = Math.floor(u({
                                min: -t.moveCenter.radius,
                                max: t.moveCenter.radius
                            })) + t.moveCenter.y;
                            const {
    ...
    class Ae {
        constructor(t) {
            ...
            }, this.updaters = [new Ie(t), new Le(t), new Fe(t), new Ee(t)]
        }
        init() {}
        isEnabled(t) {
    ...
    class Ue {
        init(t) {
            ...
            i.enable && (t.size.velocity = (t.retina.sizeAnimationSpeed ?? e.retina.sizeAnimationSpeed) / 100 * e.retina.reduceFactor, i.sync || (t.size.velocity *= l()))
        }
        isEnabled(t) {
            ...
            this.isEnabled(t) && function (t, e) {
                ...
                if (i.time || (i.time = 0), (i.delayTime ?? 0) > 0 && i.time < (i.delayTime ?? 0) && (i.time += e.value), !((i.delayTime ?? 0) > 0 && i.time < (i.delayTime ?? 0))) {
                    ...
                    i.velocity && 1 !== a && (i.velocity *= a),
                        ...
                        }(t, i.value, o, n), t.destroyed || (i.value = d(i.value, o, n))
                }
            }(t, e)
        }
    }
    async function Ve(t, e = !0) {
        await async function (t, e = !0) {
            await t.addMover("base", (() => new Ce), e)
        }(t, !1), await async function (t, e = !0) {
            await t.addShape("circle", new Se, e)
        }(t, !1), await async function (t, e = !0) {
            await t.addParticleUpdater("color", (t => new De(t)), e)
        }(t, !1), await async function (t, e = !0) {
            await t.addParticleUpdater("opacity", (t => new Re(t)), e)
        }(t, !1), await async function (t, e = !0) {
            await t.addParticleUpdater("outModes", (t => new Ae(t)), e)
        }(t, !1), await async function (t, e = !0) {
            await t.addParticleUpdater("size", (() => new Ue), e)
    ...
    async function We(t, e = !0) {
        await Ve(t, !1), await t.addPreset("stars", Be, e)
    }
    return We(ke), e
})()));